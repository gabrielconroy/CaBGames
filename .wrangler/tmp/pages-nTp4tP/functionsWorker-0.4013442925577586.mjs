...
// ../.wrangler/tmp/bundle-AM3ae8/checked-fetch.js
...
async function onRequestPost({ request, env }) {
  ...
  const newRating = (puzzle.rating * puzzle.votes + rating) / newVotes;
  await env.DB.prepare(
    "UPDATE puzzles SET rating=?, votes=? WHERE id=?"
  ).bind(newRating, newVotes, id).run();
...
async function onRequestPost2({ request, env }) {
  ...
  ).bind(body.name, JSON.stringify(body.data)).run();
  return Response.json({ success: true, id: result.meta.last_row_id });
}
__name(onRequestPost2, "onRequestPost");

// ../.wrangler/tmp/pages-nTp4tP/functionsRoutes-0.6840947606500392.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-AM3ae8/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-AM3ae8/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.4013442925577586.mjs.map
